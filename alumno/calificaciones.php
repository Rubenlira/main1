...
if ($curp) {
    ...
    $total_sql = "SELECT COUNT(*) FROM $tablas5 WHERE CURP = ?";
    ...
    <head>
        ...
        <title>Calificaciones para CURP: <?php echo htmlspecialchars($curp); ?></title>
        ...
        <main>
            <div class="content clearfix">
                <div class="main-content" id="post">
                    <h1 class="recent-post-title">Calificaciones para CURP: <?php echo htmlspecialchars($curp); ?></h1>
                    <?php
                    if ($result && $result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<a href="postCa.php?ID=' . $postID . '" class="btn">Leer Más...</a>';
                            echo '</div></div>';
                        }
                        ...
                        echo '<p>No se encontraron calificaciones para esta CURP.</p>';
                    }
                    ?>
