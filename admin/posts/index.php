...
<body>
    ...
    <main class="Admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="btn-group">
                <a href="../../admin/posts/create.php" class="btn btn-big">Crear Post</a>
            ...
            <div class="content">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT ID, Titulo, Autor FROM $tablas LIMIT ? OFFSET ?";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<tr><td colspan='6'>No hay posts</td></tr>";
                        }           
                        $stmt->close();
                        $link->close();
                        ?>
