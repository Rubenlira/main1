    ...
    <main class="Admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="btn-group">
                ...
                <a href="index.php" class="btn btn-big">Administrar Citatorio</a>
            </div>

            <div class="content">

                <h2 class="page-title">Crear Citatorio</h2>

                <form action="CreateCita.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-box-admin">
                        ...
                        <label>Título del Citatorio</label>
                    </div>
