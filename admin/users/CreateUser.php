...
<body>
    <div class="content">
        ...
        if ($_POST) {
            ...
            $queryInsert = "INSERT INTO $tablas1 (ID, Nombre, Autor, Correo, Contrasena, Nivel, Fecha) VALUES (NULL, ?, ?, ?, ?, ?, ?)";
            $stmt = $link->prepare($queryInsert);
            $stmt->bind_param("ssssss", $Usuario, $Autor, $Correo, $hashedPassword, $Nivel, $datatime);
