...
<body>
    ...
    <main class="Admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="btn-group">
                <a href="create.php" class="btn btn-big">Crear Alumno</a>
            ...
            <div class="content">
                ...
                <table>
                    ...
                    $total_sql = "SELECT COUNT(*) FROM $tablas3";
                    ...
                    $sql = "SELECT ID, CURP, Nombre, Autor FROM $tablas3 LIMIT ? OFFSET ?";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='6'>No hay alumnos</td></tr>";
                    }
