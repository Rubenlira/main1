...
<body>
    ...
    <main class="Admin-wrapper">
        ...
        <div class="admin-content">
            ...
            <div class="btn-group">
                <a href="create.php" class="btn btn-big">Crear Calificaciones</a>
            ...
            <div class="content">
                ...
                <table>
                    ...
                    $total_sql = "SELECT COUNT(*) FROM $tablas5";
                    ...
                    $sql = "SELECT ID, CURP, Titulo, Autor FROM $tablas5 LIMIT ? OFFSET ?";
